...
const STATIC_PATHS: { path: string; priority: number; frequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/sluzby/jednoucelove-stroje', priority: 0.8, frequency: 'monthly' },
  { path: '/sluzby/svarovane-konstrukce', priority: 0.8, frequency: 'monthly' },
  { path: '/sluzby/automatizace-a-robotika', priority: 0.8, frequency: 'monthly' },
  { path: '/sluzby/deskova-polohovadla', priority: 0.8, frequency: 'monthly' },
